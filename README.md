...
Se quiser, posso adicionar screenshots ao `README.md`, configurar um deploy (Vercel/Netlify) ou gerar instruções de contribuição e um arquivo `CONTRIBUTING.md`.
<<<<<<< HEAD
<<<<<<< HEAD
=======
# Coffee-Delivery
=======
>>>>>>> 0f3ef14 (Coffe Delivery v.1)
